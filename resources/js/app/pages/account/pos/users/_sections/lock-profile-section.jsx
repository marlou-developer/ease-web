    ...
    return (
        <div>
            <button
                ...
                className={
                    isLocked
                        ? " flex items-center gap-1 bg-gray-600  text-white px-3 py-1.5 rounded text-xs font-medium hover:bg-gray-700 border-red-500 border-2 "
                        : "flex items-center gap-1  bg-amber-500 text-white px-3 py-1.5 rounded text-xs font-medium hover:bg-amber-700 "
                }
            >
