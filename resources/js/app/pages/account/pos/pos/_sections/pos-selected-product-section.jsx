        ...
        <>
            ...
            <div className="flex-1 overflow-y-auto p-2">
                <div className="flex justify-end mt-1">
                    <button
                        className="text-bold text-white bg-red-500 px-3 py-1 rounded-lg hover:bg-red-600"
            ...
            <div className="p-4 bg-gray-50 border-t space-y-2">
                <div className="flex justify-between text-sm">
                    <span>Subtotal</span>{" "}
                    <span>{peso_value(cartDetail.subtotal)}</span>
                </div>
                <div className="flex justify-between text-sm">
                    <span>Total Discount</span>{" "}
                    <span>
                        {peso_value(
                            total_total_discount + overall_all_product_discount,
                        )}
                    </span>
                </div>
