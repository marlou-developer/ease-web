...
export default function TransactionStatsSection() {
    const { pos_warehouse_stats } = useSelector((store) => store.pos);
            ...
            */}
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6'>
                ...
                <StatCard 
                    ...
                    value={pos_warehouse_stats?.total_added}
                ...
                <StatCard 
                    ...
                    value={pos_warehouse_stats?.total_deducted}
                ...
                */}
                <div className="sm:col-span-2 lg:col-span-1">
                    <StatCard 
                        ...
                        value={pos_warehouse_stats?.current_stock}
