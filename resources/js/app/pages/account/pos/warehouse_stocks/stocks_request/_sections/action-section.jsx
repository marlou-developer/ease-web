...
export default function ActionSection({ props_data }) {
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='flex w-full gap-3'>
                        <Button
                            ...
                            onClick={() => action_submit('Cancelled')}
                        >
                            {loadingAction === 'Cancelled' ? 'CANCELLING...' : 'CANCEL'}
                        </Button>
                        <Button
                            variant='primary'
                            className='w-full'
                            disabled={!!loadingAction} // Disable if any action is loading
                            onClick={() => action_submit('Processing')}
                        >
                            {loadingAction === 'Processing' ? 'PROCESSING...' : 'APPROVED'}
                        </Button>
                    </div>
                </div>
            </Modal>
